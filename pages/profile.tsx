    ...
    <div className="py-10 px-4">
      <div className="flex items-center space-x-3">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-sm text-gray-900">Edit profile &rarr;</span>
        </div>
      </div>
      <div className="mt-10 flex justify-around">
        <div className="flex flex-col items-center">
          <div className="w-14 h-14 rounded-full flex items-center justify-center bg-orange-400 text-white">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
