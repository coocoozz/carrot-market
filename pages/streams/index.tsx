    ...
    <Layout title="라이브" hasTabBar>
      <div className="divide-y-2 space-y-4">
        ...
        <button
          ...
          className="fixed bottom-24 right-5 bg-orange-400 rounded-full p-4 text-white shadow-xl hover:bg-orange-500 cursor-pointer transition-colors border-transparent"
        >
          <svg
            className="w-6 h-6"
            fill="none"
